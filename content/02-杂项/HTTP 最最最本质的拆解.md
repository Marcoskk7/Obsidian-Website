...
1. **No7: [SYN]**&emsp;我->example.com&emsp;&emsp;你好, 我要跟你连接一下
2. **No8: [SYN, ACK]**&emsp;example.com-> 我&emsp;&emsp;好的, 你来吧, 我准备好了
3. **No9: [ACK]**&emsp;我->example.com&emsp;&emsp;好, 我来了
...
- ① **我**: FIN&emsp;→&emsp;"我不发了"
- ② **example.com**: ACK&emsp;←&emsp;"收到你的 FIN"
- ③ **example.com**: FIN&emsp;←&emsp;"我也不发了"&emsp;← 这里应该还有一个包
- ④ **我**: ACK&emsp;→&emsp;"收到，关了"

这里是服务器端处理成了 3 次, 看下面的讲解, 

- **No16** 我 → example.com&emsp;`[FIN, ACK]`&emsp;① 我："我不发了（FIN）"
- **No17** example.com → 我&emsp;`[FIN, ACK]`&emsp;②+③ example.com："收到你的 FIN，我也不发了"&emsp;← 合并了
- **No18** 我 → example.com&emsp;`[ACK]`&emsp;④ 我："好，关了（ACK）"
...
(推荐阅读 [https://xiaolincoding.com/network/1_base/tcp_ip_model.html](https://xiaolincoding.com/network/1_base/tcp_ip_model.html#%E5%BA%94%E7%94%A8%E5%B1%82), 本文参考了相关知识点的内容)
...
![[Pasted image 20260702205212.png]]
